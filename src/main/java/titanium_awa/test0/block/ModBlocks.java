...
// public class ModBlocks1 {
//    public static final Block TEST_BLOCK = new Block(AbstractBlock.Settings.create().strength(2.0f, 2.0f));
//    public static final Block TEST_ORE = new Block(AbstractBlock.Settings.create().strength(1.0f, 1.0f));
//
